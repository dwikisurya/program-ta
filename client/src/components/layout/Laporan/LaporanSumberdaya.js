            ...
            if (sdmq.namaProyek === formData.namaProyek) {
                return (
                    <tr key={sdmq.id}>
                        ...
                        <td>{sdmq.totalCount[undefined]}</td>
                    </tr>
                )
            }
        })
    ...
    const rendertableSDB = () => {
        return laporanSDB.map(sdbq => {
            if (sdbq.namaProyek === formData.namaProyek) {
                return (
                    <tr key={sdbq.id}>
                        <td>{sdbq.namaBarang}</td>
                        <td>{sdbq.totalCount[undefined]}</td>
                    </tr>
                )
            }
        })
        ...
        <div className="container-fluid">
            ...
            <div className="row" style={{ margin: 10 }}>
                ...
                <div className="row" style={{ margin: 10 }}>
                    <div className="col-md-12">
                        <select className="form-control" name="namaProyek" onChange={handlerChange.bind(this)}>
                            <option>     </option>
                            {renderProyek()}
                        </select><button type="button" className="btn btn-warning" onClick={() => window.location = "/laporan/sumberdaya"}>Clear</button>
                    </div>
                </div>
                ...
                <div className="col-md-5">
                    ...
                    <table className="table table-bordered" id="SDB">
                        <thead>
                            <tr>
                                <th>SDB Digunakan</th>
                                <th>Total Count</th>
